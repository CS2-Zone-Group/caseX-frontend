...
export default function InventoryFilters({
  ...
  const exteriorOptions = [
    { label: t("exteriorOptions.all"), value: "all" },
    { label: t("exteriorOptions.factoryNew"), value: "fn" },
    { label: t("exteriorOptions.minimalWear"), value: "mw" },
    { label: t("exteriorOptions.fieldTested"), value: "ft" },
    { label: t("exteriorOptions.wellWorn"), value: "ww" },
    { label: t("exteriorOptions.battleScarred"), value: "bs" },
  ];

  const categoryOptions = [
    { label: t("categoryOptions.pistols"), value: "pistols" },
    { label: t("categoryOptions.rifles"), value: "rifles" },
    { label: t("categoryOptions.smgs"), value: "smgs" },
    { label: t("categoryOptions.snipers"), value: "snipers" },
    { label: t("categoryOptions.knives"), value: "knives" },
    { label: t("categoryOptions.gloves"), value: "gloves" },
  ];
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <span className="text-white">{t("proSkins")}</span>
                  ...
                  <input
                    ...
                    checked={
                      option.value === "all"
                        ...
                        : selectedExterior.includes(option.value)
                    }
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <span className="text-white">{t("extra")}</span>
              <span className="px-2 py-0.5 bg-pink-500 text-white text-xs font-bold rounded">
                {t("new")}
              </span>
            </div>
