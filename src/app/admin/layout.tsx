      ...
      >
        ...
        <div className="flex items-center justify-between h-16 px-4 bg-gradient-to-r from-blue-600 to-indigo-600">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-white font-bold text-lg">CaseX</h1>
        ...
        <div className="p-3 border-t border-gray-200 dark:border-gray-700">
          <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-3 mb-3">
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 bg-gradient-to-br from-blue-500 to-indigo-500 rounded-lg flex items-center justify-center overflow-hidden">
                {user?.steamAvatar ? (
                  <img 
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center space-x-2">
                  ...
                  {user?.steamId && (
                    <div className="flex items-center justify-center w-4 h-4 bg-gray-800 rounded-sm" title="Steam User">
          ...
          <button
            className="flex items-center w-full px-3 py-2 mb-2 text-sm font-medium text-blue-600 dark:text-blue-400 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors"
        ...
        <header className="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between h-16 px-6">
            <div className="flex items-center space-x-4">
              <button
                className="p-2 text-gray-600 dark:text-gray-400 lg:hidden hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg"
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2 px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-400 rounded-full text-sm">
