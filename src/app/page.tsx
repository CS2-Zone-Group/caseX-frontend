      ...
      <section className="py-20 px-4 bg-gray-900 text-white">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Gloves */}
            <div className="group relative bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-6 hover:scale-105 transition-all duration-300 cursor-pointer overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="text-6xl font-bold text-gray-700 mb-4 tracking-wider">GLOVES</div>
            ...
            <div className="group relative bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-6 hover:scale-105 transition-all duration-300 cursor-pointer overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="text-6xl font-bold text-gray-700 mb-4 tracking-wider">AWP</div>
                <div className="flex items-center justify-center mb-6 h-40">
                  <div className="text-8xl">🎯</div>
                </div>
                <div className="flex justify-between items-center">
            ...
            <div className="group relative bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-6 hover:scale-105 transition-all duration-300 cursor-pointer overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="text-6xl font-bold text-gray-700 mb-4 tracking-wider">KNIVES</div>
                <div className="flex items-center justify-center mb-6 h-40">
                  <div className="text-8xl">🔪</div>
                </div>
                <div className="flex justify-between items-center">
            ...
            <div className="group relative bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-6 hover:scale-105 transition-all duration-300 cursor-pointer overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="text-6xl font-bold text-gray-700 mb-4 tracking-wider">AK-47</div>
                <div className="flex items-center justify-center mb-6 h-40">
